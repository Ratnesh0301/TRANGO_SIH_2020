...
public class Cabs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /* Intent i=new Intent();
      ...
      startActivity(i);*/
                if(ContextCompat.checkSelfPermission(Cabs.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_GRANTED)
                {
        ...
        if(ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.CAMERA))
        {
            new AlertDialog.Builder(this).setTitle("Camera Permission Needed").setMessage("You need to allow Trango to access your camera")
                    .setPositiveButton("Allow", new DialogInterface.OnClickListener() {
                        ...
                        {
                            ActivityCompat.requestPermissions(Cabs.this,new String[]{Manifest.permission.CAMERA},CAMERA_PERMISSION_CODE);
                        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults)
    {
        if(requestCode==CAMERA_PERMISSION_CODE)
        {
            ...
            {
                Toast.makeText(Cabs.this,"Permission Granted",Toast.LENGTH_SHORT).show();

            }
            else
            {
                Toast.makeText(Cabs.this,"Permission Denied",Toast.LENGTH_SHORT).show();
            }
        }
    }
}
